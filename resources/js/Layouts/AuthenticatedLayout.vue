...
<template>
    ...
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        >
            <div class="flex flex-wrap items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    >
                        <svg
                            class="mr-3 text-blue-600 w-9 h-9"
                            aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
        ...
        <aside
            class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-white border-r border-gray-200 pt-14 lg:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
            aria-label="Sidenav"
        ...
        <main class="p-4 pt-20 lg:ml-64 bg-gray-50 dark:bg-gray-900">
            <slot />
        </main>
    </div>
</template>
